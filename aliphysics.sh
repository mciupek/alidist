...
# Dependencies
module load BASE/1.0 AliRoot/$ALIROOT_VERSION-$ALIROOT_REVISION ${ROOUNFOLD_REVISION:+RooUnfold/$ROOUNFOLD_VERSION-$ROOUNFOLD_REVISION} ${TREELITE_REVISION:+treelite/$TREELITE_VERSION-$TREELITE_REVISION} ${KFPARTICLE_REVISION:+KFParticle/$KFPARTICLE_VERSION-$KFPARTICLE_REVISION} ${JEMALLOC_REVISION:+jemalloc/$JEMALLOC_VERSION-$JEMALLOC_REVISION} ${QNTOOLS_VERSION:+QnTools/$QNTOOLS_VERSION-$QNTOOLS_REVISION} ${FMT_VERSION:+fmt/$FMT_VERSION-$FMT_REVISION}
# Our environment
